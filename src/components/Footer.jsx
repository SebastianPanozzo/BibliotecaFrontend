const Footer = () => {
    return (
        <footer className="bg-color-1 text-white">
            <div className="container py-3">
                <div className="row justify-content-center text-center">
                    <div className="col-12 col-md-8">
                        <h5 className="fw-bold mb-1">Sentirse Bien Spa</h5>
                        ...
                        <div className="d-flex flex-column flex-sm-row justify-content-center align-items-center gap-3 mb-2">
                            ...
                            <div className="d-flex align-items-center gap-2">
                                ...
                                <a href="mailto:spasentirsebienmds@gmail.com" className="text-white text-decoration-none fw-medium">
                                    spasentirsebienmds@gmail.com
                                </a>
                            </div>
                        </div>
